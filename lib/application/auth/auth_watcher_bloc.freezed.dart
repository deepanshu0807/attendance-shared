...
mixin _$AuthWatcherEvent {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult authReceived(Option<AttendanceUser> userOption),
    @required TResult signedOut(AttendanceUser user),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult authCheckRequested(),
    TResult authReceived(Option<AttendanceUser> userOption),
    TResult signedOut(AttendanceUser user),
...
mixin _$AuthWatcherState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult authenticated(AttendanceUser user),
    @required TResult unauthenticated(),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult initial(),
    TResult authenticated(AttendanceUser user),
